  ...
  return (
    <div className="container">
      <header className="header">
        <div className="row">
          <div className="col-6">
            <div className="container-fluid left-box">
              <div className="title">
                <h1>
                  De toekomst van <span className="coaching">coaching</span>{" "}
                  begint hier!
                </h1>
                <p>
                  Organiseer eenvoudig je coachingstrajecten, maak gebruik van
                  krachtige coachingtools en til je coachingspraktijk of
          ...
          <div className="col-6 container-fluid right-box">
              <div className="text-box1">
                <p>
                  Dag Jane, ik hoop dat het goed met je gaat vandaag. Je bent
                  goed aan het groeien, let’s keep at it!
                </p>
              </div>
